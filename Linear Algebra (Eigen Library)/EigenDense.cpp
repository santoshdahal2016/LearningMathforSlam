...
int main(int argc, char **argv) {
    ...
    // Again you can't get the matrix dimensions wrong
    // Try to cancel the comment below and see what error Eigen will report
//     Eigen :: Matrix <double, 2, 3> result_wrong_dimension = matrix_23.cast <double> () * v_3d;

    // Some matrix operations
    // The four operations will not be demonstrated, just use +-* /.
    ...
    // Real symmetric matrix can ensure successful diagonalization
    SelfAdjointEigenSolver<Matrix3d> eigen_solver(matrix_33.transpose() * matrix_33);
    cout << "Eigen values = \n" << eigen_solver.eigenvalues() << endl;
    cout << "Eigen vectors = \n" << eigen_solver.eigenvectors() << endl;

    // Real symmetric matrix can ensure successful diagonalization
    // We solve the matrix_NN * x = v_Nd equation
    ...
    matrix_NN = matrix_NN * matrix_NN.transpose();  // guarantee positive semidefinite
    ...
    // Usually use matrix factorization, such as QR factorization, the speed will be much faster
    time_stt = clock();
